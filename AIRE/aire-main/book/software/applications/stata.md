# Stata
<!-- Brief introduction -->
Stata is a ... [official documentation](link_to_official_documentation/website).
...
| Version |  Command                     |
|---------|------------------------------|
| X.Y.Z   | `module load stata/X.Y.Z`    |

## Setting up the license
<!-- OPTIONAL -->
<!-- Instructions on how to set up the license -->
